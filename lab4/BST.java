...
public class BST{
  ...
  public void delete(int target){
    ...
    if(foundTarget){
      //invoke helper method deleteHelper
  ...
  public int findSmallest(Node node){
      //begin journey on the right side of the family
      Node journeyForSmall = node.right;
      //keep traveling left until can't travel left no more
  ...
  public void traverse(){
      //invoke helper method actuallyTraverse
